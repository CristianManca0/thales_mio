...
"""
    """def prepare_data(self, df):
        ...
        print(f"[DEBUG KNN] df_final.shape = {df_final.shape}")
        print(f"[DEBUG KNN] df_final.columns = {list(df_final.columns)}")
    ...
    def prepare_data(self, df):
        df = df.copy()
        # One-Hot Encoding pour les IP_Flags
        # MODIFICA: usare transform se già fitted, altrimenti fit_transform
        ...
        # MODIFICA: creare imputer come attributo se non esiste, poi usare transform/fit_transform
        ...
        # MODIFICA: creare scaler come attributo se non esiste, poi usare transform/fit_transform
