...
def perform_fingerprinting(
    ...
    for col in cols_to_test:
        ...
        # df_mod[col] = _perturb_col(col, df_mod, noise_level) # Original line: ERROR
        df_mod = _perturb_col(col, df_mod, noise_level) # CORRECT
...
def perform_fingerprinting3(
    ...
    tuples_to_test = [
        ...
        for col in cols_to_test
        # if col != "IP_Flags" or col != "TCP_Flags"    # Original line: ERROR
        if col != "IP_Flags" and col != "TCP_Flags"  # CORRECT
    ]
