...
BEST_PARAMS_PATH = (
    ...
    / "results_raw/without_scaler/training_results/detector_best_params.json"
...
RESULTS_DIR = Path(__file__).parent.parent / "results_raw/without_scaler/training_results"
