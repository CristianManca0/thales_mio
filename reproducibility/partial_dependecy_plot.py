...
MODEL_PATH = Path(__file__).parent.parent / "data/trained_models_raw/without_scaler/HBOS.pkl"
...
if __name__ == "__main__":
    ...
    # 4. Filter only the features that actually exist in the processed dataset
    ...
    # 5. Creazione del plot calcolando la dipendenza parziale manualmente
